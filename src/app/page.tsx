...
export default function Home() {
  ...
  return (
    <section className="min-h-screen flex justify-center items-center bg-slate-300">
      <main className="bg-zinc-100 rounded-lg w-2/3 md:w-1/2 lg:w-1/3">
          ...
          <div className=" font-[family-name:var(--font-geist-sans)]">
            ...
            <section className="flex flex-col h-1/2 gap-3 mb-7 mx-3 border-2 border-black rounded-md">
              <div className="flex flex-col gap-1">
                <div className="text-blue-700 font-semibold text-sm md:text-base mb-3 mx-1 text-center">
              ...
              <form onSubmit={handleSubmit}>
                <div className=" flex flex-col justify-center gap-3">
                  <input
                    ...
                    className="bg-slate-200 rounded-md mx-5 p-2 text-sm lg:text-lg"
                    name="text"
                    value={input}
                ...
                <span className=" mt-4 mb-2 flex justify-center">
                  <button
                    suppressHydrationWarning
                    type="submit"
                    className="bg-blue-800 text-sm lg:text-xl text-white font-semibold w-5/6 py-1 rounded-md"
                  >
                    Send
                  </button>
                </span>
